...
После выполнения пользователь получит готовую модель в папке output (формат .ply), набор новых изображений, результаты сравнения изображения с исходными данными.
В папке results находятся результаты сравнения изображений, полученных пользователем и автором данного репозитория
